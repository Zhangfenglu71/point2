...
## Data layout
```
/home/zfl/code/point2/data/{train,val,test}/
...
```
Key options: `--root /home/zfl/code/point2/data`, `--img_size 120`, `--clip_len 64`, `--batch_size 32`, `--epochs 1`, `--run_name <custom>`, `--use_amp 1`.
